...
`components/ui/` gehört der [shadcn-svelte](https://shadcn-svelte.com/docs)-CLI
(98 Dateien) — Handedits
...
- Umlaute sind erlaubt. Der Bestand mischt `ae/oe/ue` und `äöü` — beides ist
  in Ordnung, ein Umbau deswegen lohnt nicht.
...
Änderungen lesen. Mehr liegt in `docs/` nicht; abgeschlossene Vorhaben stehen in
der Commit-History, nicht als Datei.
