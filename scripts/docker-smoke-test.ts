...
async function main() {
	...
	// ---------- Wieder herunterladen und öffnen ----------
	...
	// Anhalten, wenn nur der Bestand aufgebaut werden soll - dann lässt sich in
	// die Datenbankdatei schauen, SOLANGE die Daten noch da sind. Danach zu
	// suchen würde nichts beweisen.
...
`);
	...
	// ---------- Entkoppeln, Stufe 1: dieses Gerät ----------
	console.log("\n-- Geraet loesen --");
