//! Outlook über ein PowerShell-Skript (COM) unter Windows bzw. sauberer Fallback auf anderen Plattformen.
...
/// Erstellt einen Outlook-E-Mail-Entwurf (Empfänger/Betreff/HTML-Body) und zeigt ihn an.
#[tauri::command(async)]
pub fn create_outlook_draft(
    app: tauri::AppHandle,
    to: String,
...
/// Meldet, welche Outlook-Variante verfügbar/aktiv ist.
#[tauri::command(async)]
pub fn detect_outlook(app: tauri::AppHandle) -> Result<serde_json::Value, String> {
