// Wovon hängt es ab, ob ein Browser sich reibungslos anmelden kann.
import type { Passkey } from "$lib/sync/api";

/**
 * Was diesem Browser fehlt: ein eigener Passkey, die Verpackung des
 * Vault-Schlüssels für ihn - oder nichts.
 *
 * Ohne Verpackung meldet der Passkey zwar an, öffnet die Daten aber nicht;
 * dann braucht es weiterhin die 24 Wörter.
 */
 ...
 *
 * Er entscheidet: eine Verpackung an einem anderen Passkey nützt hier nichts.
 * Ist die Kennung unbekannt - die Anmeldung lief über die 24 Wörter oder eine
