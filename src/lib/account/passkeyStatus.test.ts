// Ein Konto kann mehrere Passkeys haben - es zählt aber nur der dieses Browsers.
...
describe("missingPasskey", () => {
	...
	it("der eigene ohne Verpackung, obwohl ein anderer eine hat", () => {
		// Der Fall, den die kontoweite Prüfung übersah: an einem anderen Browser
		// hängt eine Verpackung, hier nicht - und hier nützt sie nichts.
	...
	it("ohne bekannte Kennung zaehlt das ganze Konto", () => {
		// Nach einer Anmeldung mit den 24 Wörtern oder über eine Kopplung ist
