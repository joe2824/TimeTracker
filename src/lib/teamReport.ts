...
export function nameFromSubject(subject: string, subjectFilter = ""): string | null {
	...
	// die in der Praxis vorkommt: "Joel Klein Stundenerfassung Juli 2026".
	//
 ...
 * hinten ("… – Joel Klein"), mal vorne ("Joel Klein Stundenerfassung Juli
...
function memberFromSubject(
	...
	for (const m of team) {
		...
		// Laengster Treffer gewinnt: steht "Joel" und "Joel Klein" im Team, ist
		// "Joel Klein" der genauere.
