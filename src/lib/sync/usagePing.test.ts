// Die Tagesmeldung einer Installation, die noch kein Konto verknüpft hat.
//
// Mit Konto läuft sie über `#api` und weist sich wie jeder andere Aufruf aus.
// Ohne Konto gibt es kein `#api` - dann ist der Schlüssel aus dem Build der
...
describe("Tagesmeldung ohne verknuepftes Konto", () => {
	...
	// Ohne Schlüssel käme die Meldung als 401 zurück. Gar nicht erst zu fragen
	...
	// Im Browser gibt es diesen Weg nicht: der Schlüssel liegt nicht im
	// Web-Bundle, und wer angemeldet ist, zählt ohnehin über seine Sitzung.
	...
	// Der verknüpfte Server sticht den aus dem Build - sonst zählte ein Gerät
