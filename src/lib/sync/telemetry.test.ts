...
// Der Schlüssel wird beim Bauen eingesetzt; im Test steht er sonst leer.
...
describe("Api.telemetry", () => {
	...
	// Weg hier hiesse, dass die PWA - die keinen Schlüssel aus dem Build hat -
	// gar nicht erst durchkäme.
