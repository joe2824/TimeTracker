...
/** Einen Klick auf einen Tag durchspielen und zurückgeben, was passiert ist. */
...
describe("Wunsch aus dem Bericht in die Eintraege", () => {
	...
	it("belegt, warum es kein Effekt sein darf: Kind-Effekte laufen zuerst", () => {
		// Die Einträge-Ansicht ist ein KIND der Shell; ihr Effekt läuft zuerst
		// und löscht den Wunsch, bevor die Shell ihn je zu sehen bekommt - deshalb
