// Globale Tastenkürzel (auch wenn die App im Hintergrund/Tray läuft).
// Pro Aktivität kann ein Accelerator hinterlegt werden, der den Timer startet.
import {
	register,
	unregisterAll,
	type ShortcutEvent
...
/** Registriert alle Aktivitäts-Shortcuts neu. Bei jeder Änderung aufrufen. */
 ...
 * Gibt null zurück, wenn nur Modifier gedrückt wurden.
 */
