...
// ein Formular, das Änderungen von anderen Geräten nachzieht, und ein
...
/**
 * Im `<script>` des Tabs aufrufen, nicht später: der Abgleich hängt an einem
 * `$effect`, und der gehört in die Aufbauphase der Komponente.
 */
export function createSettingsForm(): SettingsFormHandle {
	...
	// Was ein anderes Gerät ändert, kommt über den Abgleich herein und soll
	// auch in einem offenen Tab stehen - ohne zu überschreiben, was gerade
