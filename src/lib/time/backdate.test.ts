...
describe("planBackdate", () => {
	...
	it("kuerzt eine angeschnittene Zeit auf den neuen Start", () => {
		// Annas Fall: 2 h drin, Timer mit -60 Min -> 1 h wird abgezogen.
	...
	it("entfernt einen laufenden Eintrag, der ganz im neuen Zeitraum liegt", () => {
		// Ohne diese Regel entstünde hier ein Null-Sekunden-Eintrag statt der Entfernung.
...
describe("planNeedsConfirm", () => {
	...
	it("fragt NICHT beim normalen Wechsel eines laufenden Timers", () => {
		// Kürzen = Wechsel. Dafür jedes Mal ein Dialog wäre unerträglich.
	...
	it("fragt, wenn ein laufender Timer ganz entfernt wuerde", () => {
		// Seit 10:00 läuft A, um 10:30 Start "ab 09:00" -> A verschwände sonst
