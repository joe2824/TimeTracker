...
describe("deductBreakFromHours", () => {
	...
	it("schwellt auf der Brutto-, nicht auf der Nettozeit", () => {
		// 6,2 h brutto ergeben 5,45 h netto. Auf der Nettozeit geschwellt läge man
		// wieder unter 6 h und der Abzug hätte sich selbst aufgehoben.
...
describe("deductBreakFromDay", () => {
	it("verteilt den Abzug anteilig auf die Aktivitaeten", () => {
		// 5 h + 2 h = 7 h -> über 6 h, also 45 Minuten auf beide verteilt.
	...
	it("schwellt auf der Tagessumme, nicht je Aktivitaet", () => {
		// Zwei Aktivitäten mit je 3,5 h sind einzeln unter 4 h, zusammen aber
...
describe("grossForNet", () => {
	...
	it("liefert die kleinste passende Anwesenheit", () => {
		// 5,98 h und 6,48 h ergeben beide 5,73 h netto – die grössere entstünde
