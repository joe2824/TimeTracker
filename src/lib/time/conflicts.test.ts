...
const ABS = "abs";
// Lokalzeit, nicht Date.UTC: dayConflict gruppiert über fmtDate, also nach dem
// LOKALEN Tag. Mit UTC-Zeitstempeln hängt es an der Zone des Rechners, ob zwei
// Einträge überhaupt auf denselben Tag fallen – der Test prüft dann anderes,
// als er behauptet. Aus demselben Grund kein "+24h" für den Folgetag.
...
describe("overlapConflict", () => {
	...
	it("laesst aneinander anstossende Zeiten zu", () => {
		// 08:00–12:00 und 12:00–14:00 überschneiden sich nicht.
