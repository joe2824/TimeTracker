 ...
 * Geräts. Welcher Monat ein Zeitstempel ist, muss auf jedem Gerät dieselbe
...
/**
 * Einen Monatsschlüssel um `delta` Monate verschieben.
 *
 * Reine Rechnung auf "YYYY-MM", ohne Date: ein Date-Cursor hängt an der Zone
...
/** Dauer eines Eintrags in Sekunden (laufende Einträge bis `now`). */
...
/**
 * Stunden eines Eintrags. Abwesenheits-Einträge zählen als Tagesanteil * hoursPerDay
...
/**
 * Ende eines offenen Eintrags (endTs === null) für Auswertungen: gekappt auf
...
/** Eine Minute in Millisekunden – Schrittweite für `quantize`. */
...
/**
 * Epoch-ms für "YYYY-MM-DD" + "HH:MM" in der Zeitzone des Kontos. NaN bei
 * ungültiger Eingabe.
 */
...
/**
 * Einen minutengenau bearbeiteten Zeitpunkt auf den gespeicherten zurückführen,
...
/** Epoch-ms für die Tagesmitte eines "YYYY-MM-DD". */
...
/** Zerlegt [startTs, endTs] an Mitternacht in Tagesstücke. */
...
/** Hinweistext, wenn eine Spanne über Mitternacht geht – sonst null. */
...
/** Datum deutsch mit Wochentag, z.B. "Do., 16.07.2026" – für Meldungen und Tooltips. */
