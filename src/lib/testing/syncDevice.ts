// Ein nachgestelltes Gerät für die Abgleich-Tests: eigener Dateibestand,
// eigener Abgleichstand, eigene Engine gegen den nachgebauten Server.
//
// Die Tests teilen sich EINE Ablage (`fakeFs`). Wer auf einem Gerät etwas tut,
// legt deshalb zuerst dessen Dateien auf und nimmt sie danach wieder mit -
// sonst sähe das nächste Gerät die Dateien des vorigen.
...
/** Womit die Engine dieses Geräts aufgebaut wird. */
...
/** Etwas tun, BEVOR ein Konto verknüpft ist - also ohne Schreib-Haken. */
...
/** Etwas auf einem Gerät tun, mit laufender Engine. */
