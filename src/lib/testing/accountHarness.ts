...
/** Das echte `fetch`, bevor der erste Nachbau sich davorgehängt hat. */
...
/**
 * Das echte `fetch` zurückgeben.
 *
 * Symmetrisch zum Aufbau: geht ein Test unterwegs verloren, fänge der nächste
 ...
 *
 * Das Verknüpfen stösst selbst einen Abgleich an; läuft der noch, kommt
 * `syncNow` sofort und ohne Wirkung zurück. Zweimal derselbe Stand und nichts
...
/** Warten, bis die Bedingung eintritt - längstens eine Sekunde. */
