// Den anderen Fenstern sagen, dass sich die Daten geändert haben.
//
...
/** Welches Fenster hier läuft. Der Absender ignoriert seinen eigenen Ruf. */
