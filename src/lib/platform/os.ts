...
/**
 * Grob raten, worauf das hier läuft - für die Auswahl des Downloads.
 *
 * Bewusst grob: die Angabe entscheidet nur, welcher Knopf oben steht. Wer sich
 * nicht wiedererkennt, findet die übrigen Dateien trotzdem auf der
...
/**
 * Gibt es die Desktop-Anwendung für dieses System?
 *
 * Gebaut wird bisher nur für Windows (siehe .github/workflows/release.yml).
 * Solange das so ist, wäre ein Download-Knopf für alles andere ein Versprechen
 * ohne Datei dahinter.
 */
