<script lang="ts">
	...
	// Telemetry Stats
	/** Wie viele Tage Verlauf abgefragt werden. WAU und MAU hängen nicht daran. */
	const STATS_DAYS = 30;
	...
	/** Häufigstes zuerst, und nur so viele, wie sich anzeigen lassen. */
	...
	/**
	 * Ein Balken je Tag, auch für Tage ohne Meldung. Der Verlauf vom Server
	 * enthält nur Tage mit Daten - ohne die Lücken rücken zwei weit
	...
	/** Welche Beschriftungen an der Achse stehen dürfen - vom heutigen Tag aus gezählt. */
	...
	// ---------- API Calls ----------
	/** `fresh` umgeht den Puffer - nach einer Änderung soll wirklich gefragt werden. */
