<script lang="ts">
	...
	async function save() {
		...
		let count = 0;
		// Über Kalendertage laufen, nicht über Zeitstempel: an einer
		// Sommerzeit-Grenze träfe eine 24-Stunden-Addition den Tag daneben, und die
		// Wochentagsprüfung hängt sonst an der Zone des Geräts statt der des Kontos.
