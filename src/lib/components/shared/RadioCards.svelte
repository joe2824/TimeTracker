<script lang="ts">
	// Zwei bis drei Wahlmöglichkeiten als Karten nebeneinander, jede mit einer
	// Zeile darunter, die sagt, was sie bedeutet. Genau ein Feld, keine Logik -
	// wofür die Wahl steht, weiss der Aufrufer.
	...
	interface Props {
		value: string;
		/** Zwei Spalten breit; ab drei Karten bricht die dritte in die nächste Reihe. */
		options: RadioCard[];
		onChange: (value: string) => void;
		/** Präfix der Feld-ids, damit die Beschriftungen richtig verknüpft sind. */
		id: string;
		/** Feldbeschriftung darüber. */
		label: string;
	}
