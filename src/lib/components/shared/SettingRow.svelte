<script lang="ts">
	...
	interface Props {
		/** id des Bedienelements; verknüpft Label und Control.
		 *  Entfällt, wenn rechts kein einzelnes Feld steht (z.B. wechselnde Zustände). */
		id?: string;
		title: string;
		/** erklärende Zeile darunter – hier gehören Hinweise wie "0 = aus" hin */
		description?: string;
		/** das Bedienelement rechts */
		control: Snippet;
		/** Zusatzklassen für die Zeile */
		class?: string;
	}
