<script lang="ts">
	...
	interface Props {
		...
		value: number;
		/** id des Feldes, damit das Label korrekt verknüpft ist */
		id?: string;
	...
	// Zwei Knöpfe statt eines Schalters: am Schalter ist nicht zu sehen, was die
	// andere Stellung wäre - man muss ihn umlegen, um es herauszufinden.
