<script lang="ts">
	...
	/**
	 * Einmal geöffnet, bleibt aufgebaut.
	 *
	 ...
	 * Sicherungen ab - vier Anfragen für eine Ansicht, die vielleicht niemand
	 * öffnet. Beim Zeigen auf den Tab lädt `prefetchAccount` vor.
	 */
