<script lang="ts">
	...
	// (routes/team/join/[code]) braucht das ein angemeldetes Konto, siehe server/src/lib/server/teams.ts#joinTeamAsAdmin.
	...
	{#if flow.joinedTeamName}
		<div class="space-y-2 text-center">
			...
			<p class="text-muted-foreground text-sm">
				Das Team steht jetzt im Tab „Team“ – dort siehst du Mitglieder und Berichte. Die gemeinsamen
				Aktivitäten pflegst du im Tab „Aktivitäten“.
			</p>
		</div>
	...
	{:else if !account.linked}
		<div class="w-full space-y-4 text-center">
			<div class="space-y-2">
				...
				<p class="text-muted-foreground text-sm">
					Dafür brauchst du ein eigenes Konto – anders als ein einfaches Teammitglied. Melde dich an
					oder lege eins an, und öffne diesen Link danach erneut.
				</p>
			</div>
