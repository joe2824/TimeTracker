...
// Konten, und das Zurücksetzen von Umgebungsvariablen nach der Datei.
...
/** Ein Konto anlegen - ohne den Weg über eine Route. */
 ...
 * bringen.
 *
 * Vitest verwendet Worker-Prozesse für mehrere Test-Dateien wieder, und
 * `process.env` überlebt den Wechsel: was stehen bleibt, kippt die nächste
 * Datei.
 */
